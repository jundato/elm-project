...
Elm.GreenGui.Widgets.make = function (_elm) {
   ...
   var updateIcon = function () {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M31.7,65.5h-6.1c0-21.7,17.7-39.4,39.4-39.4c9.3,0,18.4,3.3,25.5,9.4l-3.9,4.6c-6-5.1-13.7-7.9-21.6-7.9 C46.7,32.2,31.7,47.2,31.7,65.5z")
                      ,$Svg$Attributes.fill("#0069AF")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M33.4,84.8")
                      ,$Svg$Attributes.fill("#0069AF")
                      ,$Svg$Attributes.stroke("#000000")
                      ,$Svg$Attributes.strokeWidth("6")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.polygon,_U.list([$Svg$Attributes.points("74.5,40.3 97,51.3 91.8,25.3"),$Svg$Attributes.fill("#0069AF")]),_U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M63.7,102.3c-9.3,0-18.4-3.3-25.5-9.4l3.9-4.6c6,5.1,13.7,7.9,21.6,7.9C82,96.2,97,81.3,97,62.9h6.1 C103,84.6,85.4,102.3,63.7,102.3z")
                      ,$Svg$Attributes.fill("#0069AF")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M94,43.2")
                      ,$Svg$Attributes.fill("#0069AF")
                      ,$Svg$Attributes.stroke("#000000")
                      ,$Svg$Attributes.strokeWidth("6")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.polygon,_U.list([$Svg$Attributes.points("52.7,87.1 30.2,76.2 35.4,102.1"),$Svg$Attributes.fill("#0069AF")]),_U.list([]))]));
   }();
   var networkIcon = function () {
      var containerHeight = 128;
      var containerWidth = 128;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.circle,
              _U.list([$Svg$Attributes.cx("64.5")
                      ,$Svg$Attributes.cy("63.6")
                      ,$Svg$Attributes.r("34.8")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
              ...
              _U.list([$Svg$Attributes.cx("64.5")
                      ,$Svg$Attributes.cy("63.6")
                      ,$Svg$Attributes.rx("19.8")
                      ,$Svg$Attributes.ry("34.8")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.line,
              _U.list([$Svg$Attributes.x1("30")
                      ,$Svg$Attributes.y1("64")
                      ,$Svg$Attributes.x2("98.5")
                      ,$Svg$Attributes.y2("64")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.line,
              _U.list([$Svg$Attributes.x1("64.2")
                      ,$Svg$Attributes.y1("98.2")
                      ,$Svg$Attributes.x2("64.2")
                      ,$Svg$Attributes.y2("29.7")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M99.4,63.6c0-11.2-5.3-21.1-13.5-27.5c-5.9,4.6-13.3,7.3-21.4,7.3S49,40.7,43.1,36.1 C35,42.5,29.7,52.4,29.7,63.6c0,10.8,4.9,20.5,12.7,26.9c6-5,13.8-8,22.2-8c8.4,0,16.2,3,22.2,8C94.4,84.1,99.4,74.4,99.4,63.6z")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M42.3,90.5c6,5,13.8,8,22.2,8c8.4,0,16.2-3,22.2-8c-6-5-13.8-8-22.2-8C56.1,82.5,48.4,85.5,42.3,90.5z")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M85.9,36.1c-5.9-4.6-13.3-7.3-21.4-7.3S49,31.5,43.1,36.1c5.9,4.6,13.3,7.3,21.4,7.3S80,40.7,85.9,36.1z")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#6D2B90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
   ...
   var monitorSharpIcon = function () {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M103.5,27.9H23.7c-1.2,0-2.1,1.3-2.1,2.9v65.7c0,1.6,1,2.9,2.1,2.9h79.8c1.2,0,2.1-1.3,2.1-2.9V30.8 C105.6,29.2,104.7,27.9,103.5,27.9z M86.1,95.7c-1,0-1.9-0.8-1.9-1.8c0-1,0.8-1.8,1.9-1.8c1,0,1.9,0.8,1.9,1.8 C88,94.9,87.1,95.7,86.1,95.7z M92.5,95.7c-1,0-1.9-0.8-1.9-1.8c0-1,0.8-1.8,1.9-1.8c1,0,1.9,0.8,1.9,1.8 C94.4,94.9,93.5,95.7,92.5,95.7z M98.9,95.7c-1,0-1.9-0.8-1.9-1.8c0-1,0.8-1.8,1.9-1.8c1,0,1.9,0.8,1.9,1.8 C100.8,94.9,100,95.7,98.9,95.7z M101.6,88.4c0,0.5-0.3,1-0.7,1H26.3c-0.4,0-0.7-0.4-0.7-1V33.5c0-0.5,0.3-1,0.7-1h74.6 c0.4,0,0.7,0.4,0.7,1V88.4z")
                      ,$Svg$Attributes.fill("#00596A")]),
              _U.list([]))
              ,A2($Svg.text$,
              _U.list([$Svg$Attributes.transform("matrix(1.2 0 0 1 48.6175 75.4754)")
                      ,$Svg$Attributes.fill("#00596A")
                      ,$Svg$Attributes.fontFamily("HelveticaNeue-Bold")
                      ,$Svg$Attributes.fontSize("43px")]),
              _U.list([$Svg.text("#")]))]));
   }();
   var labelLeftIcon = function (value) {
      ...
      _U.list([$Svg.text(value)]))]));
   };
   var labelIcon = function (value) {
      var containerHeight = 256;
      var containerWidth = 256;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
   ...
   var rightIcon = function () {
      ...
      _U.list([$Svg$Attributes.version("1.1")
              ...
              A2($Basics._op["++"],$Basics.toString(containerWidth),A2($Basics._op["++"]," ",$Basics.toString(containerHeight)))))]),
      _U.list([A2($Svg.rect,
              _U.list([$Svg$Attributes.x("39.6")
                      ,$Svg$Attributes.y("55.41")
                      ,$Svg$Attributes.width("156.97")
                      ,$Svg$Attributes.height("17.75")
                      ,$Svg$Attributes.fill("#231f20")]),
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("215.8,64.4 169.9,18.5 159.4,29.6 193.7,63.9 158.6,98.9 169.7,110"),$Svg$Attributes.fill("#231f20")]),
              _U.list([]))]));
   }();
   var leftIcon = function () {
      ...
      _U.list([$Svg$Attributes.version("1.1")
              ...
              A2($Basics._op["++"],$Basics.toString(containerWidth),A2($Basics._op["++"]," ",$Basics.toString(containerHeight)))))]),
      _U.list([A2($Svg.rect,
              _U.list([$Svg$Attributes.x("58.78")
                      ,$Svg$Attributes.y("55.41")
                      ,$Svg$Attributes.width("156.97")
                      ,$Svg$Attributes.height("17.75")
                      ,$Svg$Attributes.fill("#231f20")]),
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("39.58 64.38 85.41 18.54 95.91 29.55 61.6 63.87 96.68 98.95 85.67 109.96 39.58 64.38")
                      ,$Svg$Attributes.fill("#231f20")]),
              _U.list([]))]));
   }();
   ...
   var darkFlatThemeIcon = function () {
      var containerHeight = 128;
      var containerWidth = 128;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
              ...
              A2($Basics._op["++"],$Basics.toString(containerWidth),A2($Basics._op["++"]," ",$Basics.toString(containerHeight)))))]),
      _U.list([A2($Svg.rect,
      _U.list([$Svg$Attributes.x("10"),$Svg$Attributes.y("10"),$Svg$Attributes.width("108.8"),$Svg$Attributes.height("108.8"),$Svg$Attributes.fill("#a1a2a6")]),
      _U.list([]))]));
   }();
   var defaultFlatThemeIcon = function () {
      var containerHeight = 128;
      var containerWidth = 128;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
              ...
              A2($Basics._op["++"],$Basics.toString(containerWidth),A2($Basics._op["++"]," ",$Basics.toString(containerHeight)))))]),
      _U.list([A2($Svg.rect,
      _U.list([$Svg$Attributes.x("10"),$Svg$Attributes.y("10"),$Svg$Attributes.width("108.8"),$Svg$Attributes.height("108.8"),$Svg$Attributes.fill("#005fa9")]),
      _U.list([]))]));
   }();
   var darkThemeIcon = function () {
      var containerHeight = 128;
      var containerWidth = 128;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
      ...
      _U.list([A2($Svg.linearGradient,
              _U.list([$Svg$Attributes.id("SVGID_1_"),$Svg$Attributes.gradientUnits("userSpaceOnUse")]),
              _U.list([A2($Svg.stop,_U.list([$Svg$Attributes.offset("0"),$Svg$Attributes.stopColor("#a1a2a6")]),_U.list([]))
                      ,A2($Svg.stop,_U.list([$Svg$Attributes.offset("1"),$Svg$Attributes.stopColor("#4c4c4e")]),_U.list([]))]))
              ,A2($Svg.rect,
              _U.list([$Svg$Attributes.x("10")
                      ,$Svg$Attributes.y("10")
                      ,$Svg$Attributes.width("108.8")
                      ,$Svg$Attributes.height("108.8")
                      ,$Svg$Attributes.fill("url(#SVGID_1_)")]),
              _U.list([]))]));
   }();
   var defaultThemeIcon = function () {
      var containerHeight = 128;
      var containerWidth = 128;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
      ...
      _U.list([A2($Svg.linearGradient,
              _U.list([$Svg$Attributes.id("SVGID_1_"),$Svg$Attributes.gradientUnits("userSpaceOnUse")]),
              _U.list([A2($Svg.stop,_U.list([$Svg$Attributes.offset("0"),$Svg$Attributes.stopColor("#005fa9")]),_U.list([]))
                      ,A2($Svg.stop,_U.list([$Svg$Attributes.offset("1"),$Svg$Attributes.stopColor("#00417a")]),_U.list([]))]))
              ,A2($Svg.rect,
              _U.list([$Svg$Attributes.x("10")
                      ,$Svg$Attributes.y("10")
                      ,$Svg$Attributes.width("108.8")
   ...
   var themeIcon = function () {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.ellipse,
              _U.list([$Svg$Attributes.transform("matrix(0.7707 -0.6372 0.6372 0.7707 -13.9444 62.9444)")
                      ,$Svg$Attributes.cx("80.5")
                      ,$Svg$Attributes.cy("50.8")
                      ,$Svg$Attributes.rx("6.3")
                      ,$Svg$Attributes.ry("23.5")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#3C2F90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M55.8,102.5C53,104.8,44,98.6,35.7,88.6s-12.7-20-9.9-22.4l32.6-27c0,0,1.5,8.9,11.4,20.8s18.7,15.5,18.7,15.5L55.8,102.5z")
                      ,$Svg$Attributes.fill("none")
                      ,$Svg$Attributes.stroke("#3C2F90")
                      ,$Svg$Attributes.strokeWidth("4")
                      ,$Svg$Attributes.strokeMiterlimit("10")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M85.6,62.3c0,0,5.8,4.8,9.2,8.3s4.8,16.2,2.7,20.8c-2.2,4.7-0.1,9,2.9,9.4c2.9,0.4,4.7-1.3,5.4-6.2c0.7-4.9,0.9-19.3-13.9-30.5")
                      ,$Svg$Attributes.fill("#3C2F90")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M52.1,67.2c0-0.1-4.5-6.7-8.6-14.5c-5.7-10.7-8.1-18.5-7.2-23.1c0.4-1.9,1.3-3.3,2.7-4.2c3.9-2.5,9.1,0.4,19.9,11.5l-2.6,2.6c-10.4-10.5-14-11.8-15.3-11c-0.3,0.2-0.8,0.7-1.1,1.8C38.4,38,50.4,58.1,55.2,65.2c0,0,0.4,1.6-0.4,2.3S52.1,67.2,52.1,67.2z")
                      ,$Svg$Attributes.fill("#3C2F90")]),
              _U.list([]))
              ,A2($Svg.path,
              _U.list([$Svg$Attributes.d("M76.4,54.2L92,57.4c0,0,4.5,7.1,4.3,8.6c-0.2,1.5-1.7,5.6-5,3.7c-3.4-1.9-9.1-6.3-9.9-8c-0.7-1.7-5.8-6.8-5.8-6.8")
                      ,$Svg$Attributes.fill("#3C2F90")]),
              _U.list([]))]));
   }();
   var monitorCountIcon = function () {
      var containerHeight = 256;
      var containerWidth = 256;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
   ...
   var selectIcon = function (isOn) {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("52.6,95.9 31.2,75.3 36.2,62.3 51.7,82.6 83.9,32.2 95.7,41.3"),$Svg$Attributes.fill(iconColor)]),
              _U.list([]))]));
   };
   ...
   var upDownIcon = function (isOn) {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("44.8,21.2 23.2,42.9 28.4,47.8 44.6,31.6 61.1,48.2 66.3,43"),$Svg$Attributes.fill(iconColor)]),
              _U.list([]))
              ,A2($Svg.rect,
              ...
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("82.7,106.5 104.3,84.8 99.1,79.9 83,96.1 66.4,79.5 61.2,84.7"),$Svg$Attributes.fill(iconColor)]),
              _U.list([]))]));
   };
   var leftRightIcon = function (isOn) {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("21.5,44.9 43.1,23.3 48.1,28.5 31.9,44.7 48.4,61.2 43.2,66.4"),$Svg$Attributes.fill(iconColor)]),
              _U.list([]))
              ,A2($Svg.rect,
              ...
              _U.list([]))
              ,A2($Svg.polygon,
              _U.list([$Svg$Attributes.points("106.7,82.8 85.1,104.4 80.2,99.2 96.3,83 79.8,66.5 85,61.3"),$Svg$Attributes.fill(iconColor)]),
              _U.list([]))]));
   };
   ...
   var menuIconHeader = function () {
      ...
      _U.list([$Svg$Attributes.d("M14.43,72.7l3.44,12a1.68,1.68,0,0,0,1.87,1.2l11-2a39,39,0,0,0,7.93,10L34.17,104a1.69,1.69,0,0,0,0,1.19,1.67,1.67,0,0,0,.77.9l10.89,6a1.68,1.68,0,0,0,2.17-.48l6.32-9.2a39,39,0,0,0,12.66,1.44L71,114.31a1.67,1.67,0,0,0,2,.95l12-3.43A1.67,1.67,0,0,0,86.2,110l-2-11a39.15,39.15,0,0,0,10-7.93l10.23,4.46a1.68,1.68,0,0,0,2.09-.74l6-10.89a1.7,1.7,0,0,0-.48-2.17l-9.21-6.32a39,39,0,0,0,1.44-12.66l10.39-4.08a1.68,1.68,0,0,0,.95-2l-3.43-12a1.67,1.67,0,0,0-1.87-1.2l-11,2a39.08,39.08,0,0,0-7.93-10l4.46-10.23a1.68,1.68,0,0,0,0-1.19,1.66,1.66,0,0,0-.77-0.9l-10.88-6a1.68,1.68,0,0,0-2.17.48l-6.32,9.2a39.05,39.05,0,0,0-12.66-1.44L59,15a1.66,1.66,0,0,0-.82-0.86A1.64,1.64,0,0,0,57,14.1L45,17.53a1.64,1.64,0,0,0-1,.7,1.68,1.68,0,0,0-.25,1.16l2,11a39,39,0,0,0-10,7.93L25.66,33.84a1.67,1.67,0,0,0-2.09.75l-6,10.88a1.73,1.73,0,0,0-.17,1.18,1.7,1.7,0,0,0,.65,1L27.21,54a39,39,0,0,0-1.45,12.66L15.38,70.7a1.65,1.65,0,0,0-.86.82A1.69,1.69,0,0,0,14.43,72.7Zm29.11-1.87A22.34,22.34,0,1,1,71.17,86.15,22.34,22.34,0,0,1,43.54,70.83Z")
              ,$Svg$Attributes.transform("translate(14 14) scale(0.8)")
              ,$Svg$Attributes.fill("#FFF")]),
      _U.list([]))]));
   }();
   ...
   var monitorIcon = F2(function (label,isSelected) {
      ...
      _U.list([A2($Svg.path,
              ...
              _U.list([]))
              ,A2($Svg.text$,
              _U.list([$Svg$Attributes.transform("matrix(1 0 0 1 80 90)")
                      ,$Svg$Attributes.fontFamily("Arial-Black")
                      ,$Svg$Attributes.textAnchor("middle")
   ...
   var decrementIcon = function () {
      ...
      _U.list([$Svg$Attributes.version("1.1")
              ...
              A2($Basics._op["++"],$Basics.toString(containerWidth),A2($Basics._op["++"]," ",$Basics.toString(containerHeight)))))]),
      _U.list([A2($Svg.path,
              _U.list([$Svg$Attributes.d("M171.1,11.3v51.8c0,0-71.3,19.2-67,87.6c3.8,60.9,67,85.3,67,85.3v50.6c0,0-26.5,17.5-45.7,0 S12.7,184.9,6.6,166.6s-5.7-17.1,0-34.3S112.8,23.5,132.2,10.1C156.6-1.3,171.1,11.3,171.1,11.3z")
                      ,$Svg$Attributes.fill("#D1D3D4")]),
              _U.list([]))
              ,A2($Svg.text$,
              _U.list([$Svg$Attributes.transform("matrix(1 0 0 1 30 180)")
                      ,$Svg$Attributes.fontFamily("Arial-BoldMT")
                      ,$Svg$Attributes.fill("#414042")
                      ,$Svg$Attributes.fontSize("110px")]),
              _U.list([$Svg.text("-")]))]));
   }();
   var brightnessLine = F4(function (x1$,y1$,x2$,y2$) {
      return A2($Svg.line,
      _U.list([$Svg$Attributes.x1(x1$)
              ,$Svg$Attributes.y1(y1$)
              ,$Svg$Attributes.x2(x2$)
              ,$Svg$Attributes.y2(y2$)
              ,$Svg$Attributes.cx("89")
              ,$Svg$Attributes.cy("148")
              ,$Svg$Attributes.r("24.5")
              ,$Svg$Attributes.stroke("#FFFF00")
              ,$Svg$Attributes.strokeWidth("10")
              ,$Svg$Attributes.strokeMiterlimit("10")]),
      _U.list([]));
   });
   var brightnessIcon = function () {
      var containerHeight = 300;
      var containerWidth = 180;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
      ...
      _U.list([A2($Svg.circle,
              _U.list([$Svg$Attributes.cx("89"),$Svg$Attributes.cy("147"),$Svg$Attributes.r("24.5"),$Svg$Attributes.fill("#FFFF0B")]),
              _U.list([]))
              ,A4(brightnessLine,"89","80.6","89","113.3")
              ,A4(brightnessLine,"116.4","122.9","137.7","101.2")
              ,A4(brightnessLine,"123.3","149.7","152.2","149.7")
              ,A4(brightnessLine,"113.4","174.3","133.2","194.8")
              ,A4(brightnessLine,"89","181.1","89","213.1")
              ,A4(brightnessLine,"64.6","174.3","41","194.8")
              ,A4(brightnessLine,"52.8","149.7","22.7","149.7")
              ,A4(brightnessLine,"62","120.1","41","97.7")]));
   }();
   var incrementIcon = function () {
      var containerHeight = 300;
      var containerWidth = 180;
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
              ...
              A2($Basics._op["++"],$Basics.toString(containerWidth),A2($Basics._op["++"]," ",$Basics.toString(containerHeight)))))]),
      _U.list([A2($Svg.path,
              _U.list([$Svg$Attributes.d("M8.1,289.2v-51.8c0,0,71.3-19.2,67-87.6c-3.8-60.9-67-85.3-67-85.3V13.9c0,0,26.5-17.5,45.7,0 s112.7,101.7,118.8,120c6.1,18.3,5.7,17.1,0,34.3C166.9,185.3,66.4,277,47,290.4C22.6,301.8,8.1,289.2,8.1,289.2z")
                      ,$Svg$Attributes.fill("#D1D3D4")]),
              _U.list([]))
              ,A2($Svg.text$,
              _U.list([$Svg$Attributes.transform("matrix(1 0 0 1 86 180)")
                      ,$Svg$Attributes.fontFamily("Arial-BoldMT")
                      ,$Svg$Attributes.fill("#414042")
                      ,$Svg$Attributes.fontSize("110px")]),
              _U.list([$Svg.text("+")]))]));
   ...
   return _elm.GreenGui.Widgets.values = {_op: _op
                                         ...
                                         ,themeIcon: themeIcon
                                         ,monitorCountIcon: monitorCountIcon
                                         ,rightIcon: rightIcon
                                         ,leftIcon: leftIcon
                                         ,defaultThemeIcon: defaultThemeIcon
                                         ,darkThemeIcon: darkThemeIcon
                                         ,defaultFlatThemeIcon: defaultFlatThemeIcon
                                         ,darkFlatThemeIcon: darkFlatThemeIcon
                                         ,menuIconHeader: menuIconHeader
                                         ,exitOsdIcon: exitOsdIcon
                                         ,closeIcon: closeIcon
                                         ,labelIcon: labelIcon
                                         ,labelLeftIcon: labelLeftIcon
                                         ,monitorSharpIcon: monitorSharpIcon
...
Elm.GreenGui.Main.make = function (_elm) {
   ...
   if (_elm.GreenGui.Main.values) return _elm.GreenGui.Main.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var appTopBarHeaderIcon = function (html) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("div-1-1 vdiv-1-1")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-1 vdiv-1-1")]),_U.list([html]))]));
   };
   ...
   _U.list([A2($Html.div,_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "opacity",_1: "0"}]))]),_U.list([$Html.text("-")]))]));
   ...
   var softwareUpdateBodyView = F3(function (address,screenState,style$) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1")]),_U.list([]))
              ...
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("vdiv-1-1 div-2-3")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("vdiv-1-3 div-1-1 content-centered version")]),_U.list([$Html.text("Version V1.023")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-3 div-1-1 menu content-centered")]),
                      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("vdiv-2-3 div-2-3")]),_U.list([$GreenGui$Widgets.updateIcon]))]))]))]))]))]))
   ...
   var networkBodyView = F3(function (address,screenState,style$) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("app-body vdiv-9-10"),$Html$Attributes.style(_U.list([style$]))]),_U.list([]));
   });
   ...
   var setPresetToEdit = F2(function (preset,presets) {
      return A2($List.map,
      function (p) {
         return _U.eq(p.id,preset.id) ? _U.update(p,{isEditingName: $Basics.not(p.isEditingName),tempName: p.name}) : _U.update(p,
   ...
   var setOsdSelectButtonPress = function (monitorSettingScreenState) {
      ...
      return _U.update(monitorSettingScreenState,{selectedMonitor: _U.update(monitor,{isOsdSelectPressed: $Basics.not(monitor.isOsdSelectPressed)})});
   };
   var setOsdLeftRightButtonPress = function (monitorSettingScreenState) {
      var monitor = monitorSettingScreenState.selectedMonitor;
      return _U.update(monitorSettingScreenState,{selectedMonitor: _U.update(monitor,{isOsdLeftRightPressed: $Basics.not(monitor.isOsdLeftRightPressed)})});
   };
   var setOsdUpDownButtonPress = function (monitorSettingScreenState) {
      var monitor = monitorSettingScreenState.selectedMonitor;
      return _U.update(monitorSettingScreenState,{selectedMonitor: _U.update(monitor,{isOsdUpDownPressed: $Basics.not(monitor.isOsdUpDownPressed)})});
   };
   var setPipResizeButtonPress = function (monitorSettingScreenState) {
      var monitor = monitorSettingScreenState.selectedMonitor;
      return _U.update(monitorSettingScreenState,{selectedMonitor: _U.update(monitor,{isPipResizePressed: $Basics.not(monitor.isPipResizePressed)})});
   };
   var setPipLeftRightButtonPress = function (monitorSettingScreenState) {
      var monitor = monitorSettingScreenState.selectedMonitor;
      return _U.update(monitorSettingScreenState,{selectedMonitor: _U.update(monitor,{isPipLeftRightPressed: $Basics.not(monitor.isPipLeftRightPressed)})});
   };
   var setPipUpDownButtonPress = function (monitorSettingScreenState) {
      var monitor = monitorSettingScreenState.selectedMonitor;
      return _U.update(monitorSettingScreenState,{selectedMonitor: _U.update(monitor,{isPipUpDownPressed: $Basics.not(monitor.isPipUpDownPressed)})});
   };
   var activateCycleSignalMatrix = F2(function (signalType,monitor) {
      var newMonitor = function () {
         var _p1 = signalType;
         switch (_p1)
         {case "VGA 1": return _U.update(monitor,
              {isVgaOneCycle: $Basics.not(monitor.isVgaOneCycle)
              ,isVgaTwoCycle: false
              ,isDviOneCycle: false
              ,isDviTwoCycle: false
            ...
            case "VGA 2": return _U.update(monitor,
              {isVgaOneCycle: false
              ,isVgaTwoCycle: $Basics.not(monitor.isVgaTwoCycle)
              ,isDviOneCycle: false
              ,isDviTwoCycle: false
              ,isVideoOneCycle: false
              ,isVideoTwoCycle: false
              ,isVideoThreeCycle: false});
            case "DVI 1": return _U.update(monitor,
              {isVgaOneCycle: false
              ,isVgaTwoCycle: false
              ,isDviOneCycle: $Basics.not(monitor.isDviOneCycle)
              ,isDviTwoCycle: false
              ,isVideoOneCycle: false
              ,isVideoTwoCycle: false
              ,isVideoThreeCycle: false});
            case "DVI 2": return _U.update(monitor,
              {isVgaOneCycle: false
              ,isVgaTwoCycle: false
              ,isDviOneCycle: false
              ,isDviTwoCycle: $Basics.not(monitor.isDviTwoCycle)
              ,isVideoOneCycle: false
              ,isVideoTwoCycle: false
              ,isVideoThreeCycle: false});
            case "VIDEO 1": return _U.update(monitor,
              {isVgaOneCycle: false
              ,isVgaTwoCycle: false
              ,isDviOneCycle: false
              ,isDviTwoCycle: false
              ,isVideoOneCycle: $Basics.not(monitor.isVideoOneCycle)
              ,isVideoTwoCycle: false
              ,isVideoThreeCycle: false});
            case "VIDEO 2": return _U.update(monitor,
              {isVgaOneCycle: false
              ,isVgaTwoCycle: false
              ,isDviOneCycle: false
              ,isDviTwoCycle: false
              ,isVideoOneCycle: false
              ,isVideoTwoCycle: $Basics.not(monitor.isVideoTwoCycle)
              ,isVideoThreeCycle: false});
            case "VIDEO 3": return _U.update(monitor,
              {isVgaOneCycle: false
              ,isVgaTwoCycle: false
              ,isDviOneCycle: false
              ,isDviTwoCycle: false
              ,isVideoOneCycle: false
              ,isVideoTwoCycle: false
              ,isVideoThreeCycle: $Basics.not(monitor.isVideoThreeCycle)});
   ...
   var setSignalInputChange = F3(function (signalType,value,monitor) {
      var newMonitor = function () {
         var _p2 = signalType;
         switch (_p2)
         {case "VGA 1": return _U.update(monitor,{vgaOne: value});
            case "VGA 2": return _U.update(monitor,{vgaTwo: value});
            case "DVI 1": return _U.update(monitor,{dviOne: value});
            case "DVI 2": return _U.update(monitor,{dviTwo: value});
            case "VIDEO 1": return _U.update(monitor,{videoOne: value});
            case "VIDEO 2": return _U.update(monitor,{videoTwo: value});
            case "VIDEO 3": return _U.update(monitor,{videoThree: value});
            default: return monitor;}
      }();
      return newMonitor;
   });
   var updateMonitorList = F2(function (monitor,monitors) {
      return A2($List.map,function (m) {    return _U.eq(m.number,monitor.number) ? _U.update(monitor,{isSelected: true}) : m;},monitors);
   });
   var setVisibilityByPageIndex = F4(function (newPageIndex,monitorsPerPage,index,monitor) {
   ...
   var flipMonitorPage = F4(function (flips,maxFlips,monitorsPerPage,homeScreenState) {
      var newPageIndex = A3($Basics.clamp,0,maxFlips - 1,homeScreenState.monitorPageIndex + flips);
   ...
   var toggleMonitorAsSelected = F2(function (monitor,monitors) {
      return A2($List.map,
      function (m) {
         return _U.eq(m.number,monitor.number) ? _U.update(monitor,{isSelected: $Basics.not(monitor.isSelected)}) : m;
      },
      monitors);
   });
   var setMonitorAsSelected = F2(function (monitor,monitors) {
      return A2($List.map,
      function (m) {
   ...
   var DecreaseMonitorDisplayPress = {ctor: "DecreaseMonitorDisplayPress"};
   var IncreaseMonitorDisplayPress = {ctor: "IncreaseMonitorDisplayPress"};
   var monitorSharpBodyView = F3(function (address,screenState,style$) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-5 vdiv-1-1")]),_U.list([]))
              ...
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-5 div-1-1 content-centered")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("div-4-5 vdiv-4-5 content-centered")]),
                      _U.list([$GreenGui$Widgets.monitorSharpIcon]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-1-5 div-1-1 content-centered")]),
                      _U.list([$GreenGui$Widgets.labelIcon($Basics.toString(screenState.maxMonitorDisplays))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-5 div-1-1 content-centered")]),
                      _U.list([A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-3-5 vdiv-3-5 padded content-centered")
                                      ,A2($Html$Events.onClick,address,DecreaseMonitorDisplayPress)]),
                              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-3-4 vdiv-3-4 button")]),_U.list([$GreenGui$Widgets.leftIcon]))]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-3-5 vdiv-3-5 padded content-centered")
                                      ,A2($Html$Events.onClick,address,IncreaseMonitorDisplayPress)]),
                              _U.list([A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-3-4 vdiv-3-4 button")]),
                              _U.list([$GreenGui$Widgets.rightIcon]))]))]))]))
   ...
   var systemPreferencesTopBarView = F3(function (address,screenState,style$) {
      ...
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1 content-centered nav-header")]),
              _U.list([appTopBarHeaderIcon($GreenGui$Widgets.menuIconHeader)]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-10 float-right"),A2($Html$Events.onClick,address,CloseSetupPress)]),
              _U.list([closeIconView]))]));
   });
   var matrixSetupOptionsTopBarView = F2(function (address,screenState) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("app-top-bar vdiv-1-10")]),
   ...
   var monitorSharpTopBarView = F3(function (address,screenState,style$) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1 content-centered nav-header")]),_U.list([]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-10 float-right"),A2($Html$Events.onClick,address,BackToSystemPreferencesMain)]),
              _U.list([closeIconView]))]));
   });
   ...
   var softwareUpdateTopBarView = F3(function (address,screenState,style$) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("app-top-bar vdiv-1-10"),$Html$Attributes.style(_U.list([style$]))]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1 content-centered nav-header")]),_U.list([appTopBarHeader("")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-10 float-right"),A2($Html$Events.onClick,address,BackToSystemPreferencesMain)]),
              _U.list([closeIconView]))]));
   });
   ...
   var themeSelectorBodyView = F3(function (address,screenState,style$) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-5 vdiv-1-1")]),_U.list([]))
              ...
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-5 div-1-1 content-centered")]),
                      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-4-5 vdiv-4-5 content-centered")]),_U.list([$GreenGui$Widgets.themeIcon]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-3-5 div-1-1 content-centered")]),
                      _U.list([A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-1-4 vdiv-3-5 button padded content-centered")
                                      ,A2($Html$Events.onClick,address,ThemeSelected("Default"))]),
                              _U.list([$GreenGui$Widgets.defaultThemeIcon]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-1-4 vdiv-3-5 button padded content-centered")
                                      ,A2($Html$Events.onClick,address,ThemeSelected("Default Flat"))]),
                              _U.list([$GreenGui$Widgets.defaultFlatThemeIcon]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-1-4 vdiv-3-5 button padded content-centered")
                                      ,A2($Html$Events.onClick,address,ThemeSelected("Dark"))]),
                              _U.list([$GreenGui$Widgets.darkThemeIcon]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("div-1-4 vdiv-3-5 button padded content-centered")
                                      ,A2($Html$Events.onClick,address,ThemeSelected("Dark Flat"))]),
                              _U.list([$GreenGui$Widgets.darkFlatThemeIcon]))]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("div-1-5 vdiv-1-1")]),_U.list([]))]))]));
   });
   ...
   var systemPreferencesBodyView = F3(function (address,screenState,style$) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1")]),_U.list([]))
              ...
              _U.list([$Html$Attributes.$class("div-1-1 vdiv-1-1 content-centered")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-1-1 div-2-3 content-centered")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-3 div-2-3 menu content-centered"),A2($Html$Events.onClick,address,MonitorSharpPress)]),
                      _U.list([$GreenGui$Widgets.monitorSharpIcon]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-1-1 div-2-3 content-centered")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-3 div-2-3 menu content-centered"),A2($Html$Events.onClick,address,NetworkPress)]),
                      _U.list([$GreenGui$Widgets.networkIcon]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-1-1 div-2-3 content-centered")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-3 div-2-3 menu content-centered"),A2($Html$Events.onClick,address,ThemePress)]),
                      _U.list([$GreenGui$Widgets.themeIcon]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-1-1 div-2-3 content-centered")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-2-3 div-2-3 menu content-centered"),A2($Html$Events.onClick,address,SoftwareUpdatePress)]),
                      _U.list([$GreenGui$Widgets.updateIcon]))]))]))]))]))
              ,A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1")]),_U.list([]))]))]));
   });
   var systemPreferencesView = F3(function (address,screenState,_p4) {
      var _p5 = _p4;
      var _p8 = _p5._1;
      var _p7 = _p5._0;
      var view = function () {
         var _p6 = screenState.viewState;
         switch (_p6.ctor)
         {case "SETTINGS_HOME": return _U.list([A3(systemPreferencesTopBarView,address,screenState,_p8),A3(systemPreferencesBodyView,address,screenState,_p7)]);
            case "MONITOR_SHARP": return _U.list([A3(monitorSharpTopBarView,address,screenState,_p8),A3(monitorSharpBodyView,address,screenState,_p7)]);
            case "THEME_SELECTOR": return _U.list([A3(themeSelectorTopBarView,address,screenState,_p8),A3(themeSelectorBodyView,address,screenState,_p7)]);
            case "NETWORK": return _U.list([A3(networkTopBarView,address,screenState,_p8),A3(networkBodyView,address,screenState,_p7)]);
            default: return _U.list([A3(softwareUpdateTopBarView,address,screenState,_p8),A3(softwareUpdateBodyView,address,screenState,_p7)]);}
      }();
   ...
   var presetButtonView = F2(function (address,preset) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([$Html$Attributes.$class("preset-button-input vdiv-1-1")
                      ...
                      function (_p9) {
                         return A2($Signal.message,address,A2(PresetNameInput,preset,_p9));
                      })
   ...
   var presetSettingTopBarView = F3(function (address,presetSettingScreenState,style$) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1 content-centered nav-header")]),_U.list([appTopBarHeader(" ")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-10 float-right"),A2($Html$Events.onClick,address,ClosePresetSettings)]),
              _U.list([closeIconView]))]));
   });
   var presetSettingScreenView = F3(function (address,presetSettingScreenState,_p10) {
      ...
      return A2($Html.div,
      _U.list([]),
      _U.list([A3(presetSettingTopBarView,address,presetSettingScreenState,_p11._1)
              ,A3(presetSettingBodyView,address,presetSettingScreenState.presets,_p11._0)]));
   });
   ...
   var monitorSettingSegmentStateViewOsd = F2(function (address,monitorSettingState) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-3-4 vdiv-3-4 osd-button monitor-button content-centered ",isLeftRightOn))
                      ,A2($Html$Events.onClick,address,OsdLeftRightButtonPress)]),
              _U.list([$GreenGui$Widgets.leftRightIcon(monitor.isOsdLeftRightPressed)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-3-4 vdiv-3-4 osd-button monitor-button content-centered ",isUpDownOn))
                      ,A2($Html$Events.onClick,address,OsdUpDownButtonPress)]),
              _U.list([$GreenGui$Widgets.upDownIcon(monitor.isOsdUpDownPressed)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-3-4 vdiv-3-4 osd-button monitor-button content-centered ",isSelectedOn))
                      ,A2($Html$Events.onClick,address,OsdSelectButtonPress)]),
              _U.list([$GreenGui$Widgets.selectIcon(monitor.isOsdSelectPressed)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-3-4 vdiv-3-4 pip-button monitor-button content-centered ")
   ...
   var osdButtonSetView = F2(function (address,monitorSettingScreenState) {
      ...
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-1-3 ",isVisible))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("vdiv-1-2")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("div-1-2 align-center")]),
                      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("vdiv-1-5")]),_U.list([$Html.text("LEFT/RIGHT")]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("vdiv-4-5")]),
                              _U.list([A2($Html.img,
                              _U.list([$Html$Attributes.$class("vdiv-1-1")
                                      ,$Html$Attributes.src(leftRightSrc)
                                      ,A2($Html$Events.onClick,address,OsdLeftRightButtonPress)]),
                              _U.list([]))]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("div-1-2 align-center")]),
                      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("vdiv-1-5")]),_U.list([$Html.text("UP/DOWN")]))
                              ,A2($Html.div,
                              _U.list([$Html$Attributes.$class("vdiv-4-5")]),
                              _U.list([A2($Html.img,
                              _U.list([$Html$Attributes.$class("vdiv-1-1")
                              ...
                              _U.list([]))]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("vdiv-1-2 align-center")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-1 align-center")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("vdiv-1-5")]),_U.list([$Html.text("SELECT")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-4-5")]),
                      _U.list([A2($Html.img,
                      _U.list([$Html$Attributes.$class("vdiv-1-1"),$Html$Attributes.src(selectSrc),A2($Html$Events.onClick,address,OsdSelectButtonPress)]),
                      _U.list([]))]))]))]))]));
   });
   ...
   var monitorSettingSegmentStateViewPip = F2(function (address,monitorSettingState) {
      ...
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-3-4 vdiv-3-4 pip-button monitor-button content-centered ",isLeftRightOn))
                      ,A2($Html$Events.onClick,address,PipLeftRightButtonPress)]),
              _U.list([$GreenGui$Widgets.leftRightIcon(monitor.isPipLeftRightPressed)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-3-4 vdiv-3-4 pip-button monitor-button content-centered ",isUpDownOn))
                      ,A2($Html$Events.onClick,address,PipUpDownButtonPress)]),
              _U.list([$GreenGui$Widgets.upDownIcon(monitor.isPipUpDownPressed)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-3-4 vdiv-3-4 pip-button monitor-button content-centered ",isResizeOn))
                      ,A2($Html$Events.onClick,address,PipResizeButtonPress)]),
              _U.list([$GreenGui$Widgets.resizeIcon(monitor.isPipResizePressed)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-4 content-centered")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-3-4 vdiv-3-4 pip-button monitor-button content-centered ")
   ...
   var pipButtonSetView = F2(function (address,monitorSettingScreenState) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-1 align-center")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("vdiv-1-5")]),_U.list([$Html.text("RESIZE")]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("vdiv-4-5")]),
                      _U.list([A2($Html.img,
   ...
   var monitorSettingTopBarView = F3(function (address,monitorSettingScreenState,style$) {
      ...
      _U.list([A2($Html.div,
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-10 float-right"),A2($Html$Events.onClick,address,CloseMonitorConfiguration)]),
              _U.list([closeIconView]))]));
   });
   ...
   var signalMatrixView = F5(function (address,signalType,signalName,monitorSettingScreenState,monitor) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("signal-matrix-label div-1-1 vdiv-1-2 content-centered")]),_U.list([$Html.text(signalType)]))
              ...
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-1-1 vdiv-1-1 content-centered ",signalType))]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"signal-matrix-input div-3-5 vdiv-1-1 content-centered ",isActivated ? " activated" : ""))
   ...
   var monitorSettingUpperBodyView = F2(function (address,monitorSettingScreenState) {
      var monitor = monitorSettingScreenState.selectedMonitor;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("monitor-setting-upper-body div-1-1")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("div-1-3 vdiv-1-1")]),
   ...
   var monitorSettingScreenView = F3(function (address,monitorSettingScreenState,_p14) {
      ...
      _U.list([A3(monitorSettingTopBarView,address,monitorSettingScreenState,_p15._1),A3(monitorSettingBodyView,address,monitorSettingScreenState,_p15._0)]));
   });
   ...
   var homePanelView = F2(function (address,homeScreenState) {
      var powerButtonState = homeScreenState.isPowerDisabled ? "_disabled" : "";
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("home-panel-view")]),
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-3-5 vdiv-3-5")]),_U.list([$GreenGui$Widgets.nightModeIcon]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("home-panel-division div-1-4 vdiv-1-1")]),
              _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class(" content-centered presets")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-3-5 vdiv-3-5")]),_U.list([$GreenGui$Widgets.pipMenuIcon]))]))]))]));
   });
   ...
   var homeMenuView = F2(function (address,style$) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("content-centered vdiv-1-1 div-1-1")]),_U.list([$GreenGui$Widgets.lockIcon]))]))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("content-centered vdiv-1-1 div-1-1")]),_U.list([$GreenGui$Widgets.presetIcon]))]))
              ,A2($Html.div,
              ...
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("content-centered vdiv-1-1 div-1-1")]),_U.list([$GreenGui$Widgets.menuIcon]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("home-menu-item vdiv-1-1 div-1-4 content-centered")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("content-centered vdiv-1-1 div-1-1")]),_U.list([$GreenGui$Widgets.informationIcon]))]))]));
   });
   ...
   var LongPressedMonitor = function (a) {    return {ctor: "LongPressedMonitor",_0: a};};
   ...
   var monitorViewPager = F2(function (address,screenState) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-10 vdiv-1-1")]),_U.list([]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("div-4-5 vdiv-1-1")]),
              _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("div-1-1 vdiv-2-5")]),_U.list([]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("div-1-1 vdiv-3-5 content-centered")]),
                      _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("div-1-5 vdiv-1-1 monitor-selectall-button"),A2($Html$Events.onClick,address,SelectAllMonitors)]),
   ...
   var monitorViewButton = F3(function (address,systemPreferencesScreenState,monitor) {
      var maxMonitorDisplays = $Basics.toString(systemPreferencesScreenState.maxMonitorDisplays);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"div-1-",A2($Basics._op["++"],maxMonitorDisplays," monitor-view-container ")))]),
      _U.list([A2($Html.div,
   ...
   var monitorViewButtons = F3(function (address,monitors,systemPreferencesScreenState) {
      return A2($List.map,A2(monitorViewButton,address,systemPreferencesScreenState),monitors);
   });
   var monitorPanelView = F3(function (address,homeScreenState,systemPreferencesScreenState) {
      return A2($Html.div,
   ...
   var homeScreenView = F4(function (address,homeScreenState,systemPreferencesScreenState,_p16) {
      var _p17 = _p16;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("main"),$Html$Attributes.style(_U.list([_p17._0]))]),
      _U.list([A3(monitorPanelView,address,homeScreenState,systemPreferencesScreenState)
              ,A2(homePanelView,address,homeScreenState)
              ,A2(homeMenuView,address,_U.list([_p17._1]))
              ,buildVersion]));
   });
   var NoOp = {ctor: "NoOp"};
   ...
   var pressedMonitor = function () {
      var toSelector = function (action) {    var _p18 = action;if (_p18.ctor === "MonitorPressedDown") {    return _p18._0;} else {    return "";}};
      var needsMonitorPressedDown = function (action) {
         var _p19 = action;
         if (_p19.ctor === "MonitorPressedDown") {
               return true;
            } else {
               return false;
            }
   ...
   var pressReleasedMonitor = function () {
      var toSelector = function (action) {    var _p20 = action;if (_p20.ctor === "MonitorPressReleased") {    return _p20._0;} else {    return "";}};
      var needsMonitorPressReleased = function (action) {
         var _p21 = action;
         if (_p21.ctor === "MonitorPressReleased") {
               return true;
            } else {
               return false;
            }
   ...
   var lockScreenPressed = function () {
      var toSelector = function (action) {    var _p22 = action;if (_p22.ctor === "LockScreenPressed") {    return _p22._0;} else {    return "";}};
      var needsLockScreenPressed = function (action) {    var _p23 = action;if (_p23.ctor === "LockScreenPressed") {    return true;} else {    return false;}};
   ...
   var appView = F2(function (address,appState) {
      ...
      var viewToDisplay = function () {
         var _p26 = appState.viewState;
         switch (_p26)
         {case 1: return A4(homeScreenView,address,homeScreenState,systemPreferencesScreenState,{ctor: "_Tuple2",_0: styleA,_1: styleB});
   ...
   var findMonitor = F2(function (number,monitors) {
      var _p27 = A2($List.take,1,A2($List.filter,function (m) {    return _U.eq(m.number,number);},monitors));
   ...
   var defaultHomeScreenState = {monitorPageIndex: 0
                                ...
                                ,monitors: _U.list([A2(defaultMonitor,"1",true)
                                                   ...
                                                   ,A2(defaultMonitor,"4",true)
                                                   ,A2(defaultMonitor,"5",true)
                                                   ,A2(defaultMonitor,"6",false)
                                                   ,A2(defaultMonitor,"7",false)
                                                   ,A2(defaultMonitor,"8",false)
                                                   ,A2(defaultMonitor,"9",false)
   ...
   var addSignalInputMatrix = function (screenState) {
      var newScreenState = function () {
         var _p28 = screenState.setupIndex;
         switch (_p28)
   ...
   var defaultSystemPreferencesScreenState = {viewState: SETTINGS_HOME,themeSelectScreenState: defaultThemeSelectScreenState,maxMonitorDisplays: 4};
   var ThemeSelectScreenState = function (a) {    return {selectedTheme: a};};
   var SystemPreferencesScreenState = F3(function (a,b,c) {    return {viewState: a,themeSelectScreenState: b,maxMonitorDisplays: c};});
   ...
   var update = F2(function (action,appState) {
      ...
      {case "NoOp": return appState;
         case "SelectMonitor": var homeScreenState$ = appState.homeScreenState;
           var monitors$ = A2(toggleMonitorAsSelected,_p29._0,homeScreenState$.monitors);
         ...
         case "SelectMonitorToConfigure": var _p30 = _p29._0;
           var monitorSettingScreenState$ = appState.monitorSettingScreenState;
           var homeScreenState$ = appState.homeScreenState;
           return _U.update(appState,
           {viewState: 2
           ,homeScreenState: _U.update(homeScreenState$,{monitors: A2(setMonitorAsSelected,_p30,homeScreenState$.monitors)})
           ,monitorSettingScreenState: _U.update(monitorSettingScreenState$,{selectedMonitor: _p30,signalMatrixInputs: _U.list([])})});
         ...
         case "LongPressedMonitor": var homeScreenState$ = appState.homeScreenState;
           var foundMonitor = A2(findMonitor,_p29._0,homeScreenState$.monitors);
           var monitorSettingScreenState$ = appState.monitorSettingScreenState;
           return _U.update(appState,
           {viewState: 2
         ...
         case "SignalInputChange": var monitorSettingScreenState$ = appState.monitorSettingScreenState;
           var monitor$ = monitorSettingScreenState$.selectedMonitor;
           return _U.update(appState,
           {monitorSettingScreenState: _U.update(monitorSettingScreenState$,{selectedMonitor: A3(setSignalInputChange,_p29._0,_p29._1,monitor$)})});
         case "SignalInputSelect": var monitorSettingScreenState$ = appState.monitorSettingScreenState;
           ...
           {selectedMonitor: A3(setSignalInputChange,_p29._0,_p29._1,monitor$)
           ,isVgaOneSelectOpen: false
           ,isVgaTwoSelectOpen: false
           ,isDviOneSelectOpen: false
           ,isDviTwoSelectOpen: false
         ...
         case "PresetSelected": var homeScreenState$ = appState.homeScreenState;
           return _U.update(appState,{homeScreenState: _U.update(homeScreenState$,{monitors: _p29._0.monitors})});
         case "PresetEdit": var presetSettingScreenState$ = appState.presetSettingScreenState;
           return _U.update(appState,
           {presetSettingScreenState: _U.update(presetSettingScreenState$,{presets: A2(setPresetToEdit,_p29._0,presetSettingScreenState$.presets)})});
         case "PresetCommit": var monitors = appState.homeScreenState.monitors;
           var presetSettingScreenState$ = appState.presetSettingScreenState;
           return _U.update(appState,
           {presetSettingScreenState: _U.update(presetSettingScreenState$,{presets: A3(setPresetCommit,_p29._0,presetSettingScreenState$.presets,monitors)})});
         case "PresetNameInput": var presetSettingScreenState$ = appState.presetSettingScreenState;
           return _U.update(appState,
           {presetSettingScreenState: _U.update(presetSettingScreenState$,{presets: A3(setPresetName,_p29._0,_p29._1,presetSettingScreenState$.presets)})});
         case "PresetNameEditDone": var presetSettingScreenState$ = appState.presetSettingScreenState;
           return _U.update(appState,
           {presetSettingScreenState: _U.update(presetSettingScreenState$,{presets: A2(setPresetNameCommit,_p29._0,presetSettingScreenState$.presets)})});
         case "PresetEditCancel": var presetSettingScreenState$ = appState.presetSettingScreenState;
           return _U.update(appState,
           {presetSettingScreenState: _U.update(presetSettingScreenState$,{presets: A2(cancelPresetEdit,_p29._0,presetSettingScreenState$.presets)})});
         ...
         case "IncreaseMonitorDisplayPress": var systemPreferencesScreenState$ = appState.systemPreferencesScreenState;
           return _U.update(appState,
           {systemPreferencesScreenState: _U.update(systemPreferencesScreenState$,
           {maxMonitorDisplays: A3($Basics.clamp,2,12,systemPreferencesScreenState$.maxMonitorDisplays + 1)})});
         case "DecreaseMonitorDisplayPress": var systemPreferencesScreenState$ = appState.systemPreferencesScreenState;
           return _U.update(appState,
           {systemPreferencesScreenState: _U.update(systemPreferencesScreenState$,
           {maxMonitorDisplays: A3($Basics.clamp,2,12,systemPreferencesScreenState$.maxMonitorDisplays - 1)})});
         ...
         default: var lockCountdownScreenState$ = appState.lockCountdownScreenState;
           return _U.update(appState,{lockCountdownScreenState: _U.update(lockCountdownScreenState$,{secondsLeft: _p29._0})});}
   });
   ...
   return _elm.GreenGui.Main.values = {_op: _op
                                      ...
                                      ,IncreaseMonitorDisplayPress: IncreaseMonitorDisplayPress
                                      ,DecreaseMonitorDisplayPress: DecreaseMonitorDisplayPress
                                      ...
                                      ,backIcon: backIcon
                                      ,appTopBarSpacer: appTopBarSpacer
                                      ,appTopBarHeader: appTopBarHeader
                                      ,appTopBarHeaderIcon: appTopBarHeaderIcon
                                      ,closeIconView: closeIconView
